...
class MonsterType
{
	public:
		...
		bool createLootContainer(Container* parent, const LootBlock& lootblock, Player* player);
		std::vector<Item*> createLootItem(const LootBlock& lootBlock, Player* player);
};
