...
class LuaScriptInterface
{
	...
	protected:
		...
		static int luaPlayerGetCriticalHitChance(lua_State* L);
		static int luaPlayerGetDodgeChance(lua_State* L);
		static int luaPlayerGetLifeAbsorb(lua_State* L);
		static int luaPlayerGetManaAbsorb(lua_State* L);
		static int luaPlayerGetLifeLeech(lua_State* L);
		static int luaPlayerGetManaLeech(lua_State* L);
		static int luaPlayerGetReflect(lua_State* L);
		static int luaPlayerGetMomentum(lua_State* L);
		...
		static int luaItemTypeGetDodgeChance(lua_State* L);
		static int luaItemTypeGetLifeAbsorb(lua_State* L);
		static int luaItemTypeGetManaAbsorb(lua_State* L);
		static int luaItemTypeGetLifeLeech(lua_State* L);
		static int luaItemTypeGetManaLeech(lua_State* L);
		static int luaItemTypeGetReflect(lua_State* L);
		static int luaItemTypeGetMomentum(lua_State* L);
