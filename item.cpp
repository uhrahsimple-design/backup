                                 ...
                                 const Item* item /*= nullptr*/, int32_t subType /*= -1*/, bool addArticle /*= true*/)
{
	...
	if (it.isRune()) {
		...
		it.criticalHitChance != 0 || it.dodgeChance != 0 || it.lifeAbsorb != 0 || it.manaAbsorb != 0 ||
		...
		item->getManaAbsorb() != 0 || item->getLifeLeech() != 0 || item->getManaLeech() != 0 || item->getReflect() != 0 || item->getMomentum() != 0))) {
		bool begin = true;
