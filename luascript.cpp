...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(ITEM_ATTRIBUTE_DODGECHANCE)
	registerEnum(ITEM_ATTRIBUTE_LIFEABSORB)
	registerEnum(ITEM_ATTRIBUTE_MANAABSORB)
	...
	registerMethod("Player", "getCriticalHitChance", LuaScriptInterface::luaPlayerGetCriticalHitChance);
	registerMethod("Player", "getDodgeChance", LuaScriptInterface::luaPlayerGetDodgeChance);
	registerMethod("Player", "getLifeAbsorb", LuaScriptInterface::luaPlayerGetLifeAbsorb);
	registerMethod("Player", "getManaAbsorb", LuaScriptInterface::luaPlayerGetManaAbsorb);
	registerMethod("Player", "getLifeLeech", LuaScriptInterface::luaPlayerGetLifeLeech);
	registerMethod("Player", "getManaLeech", LuaScriptInterface::luaPlayerGetManaLeech);
	registerMethod("Player", "getReflect", LuaScriptInterface::luaPlayerGetReflect);
	registerMethod("Player", "getMomentum", LuaScriptInterface::luaPlayerGetMomentum);
...
registerMethod("ItemType", "getCriticalHitChance", LuaScriptInterface::luaItemTypeGetCriticalHitChance);
	registerMethod("ItemType", "getDodgeChance", LuaScriptInterface::luaItemTypeGetDodgeChance);
	registerMethod("ItemType", "getLifeAbsorb", LuaScriptInterface::luaItemTypeGetLifeAbsorb);
	registerMethod("ItemType", "getManaAbsorb", LuaScriptInterface::luaItemTypeGetManaAbsorb);
	registerMethod("ItemType", "getLifeLeech", LuaScriptInterface::luaItemTypeGetLifeLeech);
	registerMethod("ItemType", "getManaLeech", LuaScriptInterface::luaItemTypeGetManaLeech);
	registerMethod("ItemType", "getReflect", LuaScriptInterface::luaItemTypeGetReflect);
	registerMethod("ItemType", "getMomentum", LuaScriptInterface::luaItemTypeGetMomentum);
...
int LuaScriptInterface::luaPlayerGetCriticalHitChance(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getCriticalHitChance()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetDodgeChance(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getDodgeChance()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetLifeAbsorb(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getLifeAbsorb()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetManaAbsorb(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getManaAbsorb()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetLifeLeech(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getLifeLeech()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetManaLeech(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getManaLeech()); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaPlayerGetMomentum(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		lua_pushnumber(L, player->getMomentum());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPlayerGetReflect(lua_State* L)
{
	Player* player = getUserdata<Player>(L, 1);
	if (player) lua_pushnumber(L, player->getReflect()); else lua_pushnil(L);
	return 1;
}
...
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->criticalHitChance); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaItemTypeGetDodgeChance(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->dodgeChance); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaItemTypeGetLifeAbsorb(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->lifeAbsorb); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaItemTypeGetManaAbsorb(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->manaAbsorb); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaItemTypeGetLifeLeech(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->lifeLeech); else lua_pushnil(L);
	return 1;
}

int LuaScriptInterface::luaItemTypeGetManaLeech(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->manaLeech); else lua_pushnil(L);
	return 1;
}
...
int LuaScriptInterface::luaItemTypeGetAbilities(lua_State* L)
{
	...
	const uint16_t subType = getNumber<uint16_t>(L, 3, 0);
	const Abilities& abilities = const_cast<ItemType*>(itemType)->getAbilities();

	if (ability == "stats") {
		lua_pushnumber(L, (subType <= STAT_LAST) ? abilities.stats[subType] : 0);
	} else if (ability == "statsPercent") {
		lua_pushnumber(L, (subType <= STAT_LAST) ? abilities.statsPercent[subType] : 0);
	} else if (ability == "skills") {
		lua_pushnumber(L, (subType <= SKILL_LAST) ? abilities.skills[subType] : 0);
	} else if (ability == "fieldAbsorbPercent") {
		lua_pushnumber(L, (subType < COMBAT_COUNT) ? abilities.fieldAbsorbPercent[subType] : 0);
	} else if (ability == "absorbPercent") {
		lua_pushnumber(L, (subType < COMBAT_COUNT) ? abilities.absorbPercent[subType] : 0);
	} else if (ability == "speed") {
		lua_pushnumber(L, abilities.speed);
	} else if (ability == "healthGain") {
		lua_pushnumber(L, abilities.healthGain);
	} else if (ability == "healthTicks") {
		lua_pushnumber(L, abilities.healthTicks);
	} else if (ability == "manaGain") {
		lua_pushnumber(L, abilities.manaGain);
	} else if (ability == "manaTicks") {
		lua_pushnumber(L, abilities.manaTicks);
	} else if (ability == "elementType") {
		lua_pushnumber(L, abilities.elementType);
	} else if (ability == "elementDamage") {
		lua_pushnumber(L, abilities.elementDamage);
	} else if (ability == "manaShield") {
	...
	} else if (ability == "conditionImmunities") {
		lua_pushnumber(L, abilities.conditionImmunities);
	} else if (ability == "conditionSuppressions") {
		lua_pushnumber(L, abilities.conditionSuppressions);
	} else {
		lua_pushnumber(L, 0);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetMomentum(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		lua_pushnumber(L, itemType->momentum);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetReflect(lua_State* L)
{
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) lua_pushnumber(L, itemType->reflect); else lua_pushnil(L);
	return 1;
}
